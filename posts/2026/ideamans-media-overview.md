...
description: AIエージェント（Claude Code）とモノレポを組み合わせた自社メディア運営の自動化プラットフォーム。SNS投稿・HTMLメール配信の99%を自動化したセカンドフェーズの全容を公開する。
...
ブログ記事を書く感覚でMarkdownメール原稿を作成すると、CMSがHTMLメールに変換。API連携でMauticのメール配信下書きに一括投入される。
