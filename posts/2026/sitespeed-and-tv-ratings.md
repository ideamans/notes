...
description: サイトスピードとテレビ視聴率は確率的に同一の構造を持つ。「良い体験が新規行動を生む」のではなく「離脱を防ぐことで本来あり得た成果を取り戻す」という因果メカニズムを解説する。
...
**この「観測できない機会損失」が、実は日常的かつ大量に発生している。**
...
彼らは **どの番組を見るか決めていない** 。しかし、あるチャンネルへ切り替えた瞬間にたまたま面白い場面が映っていれば、 **そこで手を止めて視聴を続ける** 。番組が面白ければ面白いほど、この「浮動的な視聴者」がそのチャンネルに留まる確率が上がる。
