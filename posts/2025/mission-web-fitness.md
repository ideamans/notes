...
description: 画像軽量化・ページ表示速度改善・アクセスランキング効率化という3つの事業に共通する「WebにおけるムダをなくしたいI」という思想を解説。デジタル赤字・クラウドコスト・ユーザー体験の観点から、アイデアマンズが目指す「Webフィットネス」のミッションを語る。
...
ご存じのとおり、AWSをはじめ海外のクラウドサービスの利用が増えている。これは貿易上の輸入に相当し、貿易赤字(デジタル赤字)が拡大している。
