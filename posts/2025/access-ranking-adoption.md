...
description: ニュース系メディアサイト220サイトを対象にアクセスランキングの採用率を調査。全体平均74%で、地方紙・IT専業メディアは90%超、一方で専門性の高いメディアは平均以下という実態とジャンル別の傾向を公開データで解説する。
...
サイトの選定には、AIディープリサーチを利用した。そのため厳密な選定基準を設けていない点は留意されたい。
...
また、メディアの性質によっても違いはあり、呼称としては「アクセスランキング」が最も一般的だと確かめられた。
