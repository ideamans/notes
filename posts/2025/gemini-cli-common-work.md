...
人間であればまずサイトを Web 検索し、実際にサイトを表示する。そしてアクセスランキングがあるかを確認し、その結果を読売新聞の例を参考にしながら表へ書き込む。この作業を繰り返すだろう。
...
しかし **LLM ベースの AI にとっては、コードとデータの両方が確率の高いテキストを紡ぐ点において等価** なのかもしれない。
