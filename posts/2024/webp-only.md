...
description: WebPの国内対応率96.4%到達を受け、WebP一択移行の是非を多角的に検討。透過・アニメーション・可逆圧縮を全て網羅する万能性は評価できる一方、供給サイドの対応遅れ・エコシステムの懸念・技術負債リスクなど反対論もバランスよく論じる。
id: miyanaga
...
すでにWebPは、OSやSDKのレベルでも広く対応フォーマットの一つとなっているが、アプリの実装がそれへシームレスに対応できるかは不明である。
...
WebPは画質や汎用性を犠牲にしている面がある。そもそも **配信向けに軽量化することへ特化** している。
...
そうでないサイトについては、当面はこれまで通りJPEGやPNGで画像を用意しながら、配信用としては軽量なWebPに変換する方法が無難かもしれない。
