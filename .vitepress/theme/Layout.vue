    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 xl:max-w-5xl xl:px-0">
      <nav class="flex justify-between items-center py-10 font-bold">
        <a class="text-3xl flex flex-row items-center" href="/" aria-label="ideaman's Notes">
          <img class="inline-block mr-2" style="width: 196px; height: 46px" alt="logo" src="/logo.svg" />
        ...
        <div class="text-sm text-gray-500 dark:text-white leading-5">
          ...
          <a class="hover:text-gray-700 dark:hover:text-gray-200" href="/feed.rss">RSS<span class="hidden sm:inline">
              Feed</span></a>
          <span class="mr-2 ml-2">·</span>
          <a class="hover:text-gray-700 dark:hover:text-gray-200" href="https://www.ideamans.com/" target="_blank"
            rel="noopener">アイデアマンズ株式会社 →</a>
        </div>
      </nav>
    </div>
